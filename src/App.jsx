...
const MODULOS = [
  {
    ...
    icono: "🛒",
    status: "activo",
    url: "https://integra.compras.paranalogistica.com.ar",
    color: "#235C96",
  ...
  },
  {
    ...
    icono: "🍱",
    status: "activo",
    url: "https://integra.viveres.paranalogistica.com.ar",
    color: "#1A7A6E",
  ...
  },
  {
    ...
    icono: "📋",
    status: "activo",
    url: "https://integra.projects.paranalogistica.com.ar",
    color: "#6B4FA0",
  ...
  },
  {
    ...
    icono: "⚙️",
    status: "activo",
    url: "https://integra.mantenimiento.paranalogistica.com.ar",
    color: "#374151",
  ...
  },
  {
    ...
    icono: "🔧",
    status: "activo",
    url: "https://integra.ssrr.paranalogistica.com.ar",
    color: "#B07D0A",
  ...
  },
  {
    ...
    icono: "📜",
    status: "activo",
    url: "https://integra.certificados.paranalogistica.com.ar",
    color: "#0E7490",
  ...
  },
  {
    ...
    icono: "💰",
    status: "activo",
    url: "https://integra.costtracker.paranalogistica.com.ar",
    color: "#B8942A",
...
.login-card {
  ...
  border: 1px solid rgba(184,148,42,0.2); border-radius: 16px;
      ...
      <div className="login-split">
        ...
        <div className="login-left">
          ...
          <div className="login-left-sub">
            We Find the Way, or We Make One.
          </div>
        </div>
